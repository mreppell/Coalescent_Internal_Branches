...
#   include <ib_boost/mpl/numeric_cast.hpp>
#   include <ib_boost/mpl/apply_wrap.hpp>
#   include <ib_boost/mpl/if.hpp>
#   include <ib_boost/mpl/tag.hpp>
#   include <ib_boost/mpl/aux_/numeric_cast_utils.hpp>
#   include <ib_boost/mpl/aux_/na.hpp>
#   include <ib_boost/mpl/aux_/na_spec.hpp>
#   include <ib_boost/mpl/aux_/lambda_support.hpp>
#   include <ib_boost/mpl/aux_/msvc_eti_base.hpp>
#   include <ib_boost/mpl/aux_/value_wknd.hpp>
#   include <ib_boost/mpl/aux_/config/eti.hpp>
...
#   include <ib_boost/mpl/aux_/preprocessor/sub.hpp>
#   include <ib_boost/mpl/aux_/config/ctps.hpp>
#   include <ib_boost/mpl/aux_/config/eti.hpp>
#   include <ib_boost/mpl/aux_/config/msvc.hpp>
#   include <ib_boost/mpl/aux_/config/workaround.hpp>

#   include <ib_boost/preprocessor/dec.hpp>
...
#define BOOST_PP_ITERATION_PARAMS_1 \
    (3,( BOOST_PP_DEC(AUX778076_OP_ARITY), 2, <ib_boost/mpl/aux_/numeric_op.hpp> ))
