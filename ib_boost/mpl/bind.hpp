...
#   include <ib_boost/mpl/bind_fwd.hpp>
#   include <ib_boost/mpl/placeholders.hpp>
#   include <ib_boost/mpl/next.hpp>
#   include <ib_boost/mpl/protect.hpp>
#   include <ib_boost/mpl/apply_wrap.hpp>
#   include <ib_boost/mpl/limits/arity.hpp>
#   include <ib_boost/mpl/aux_/na.hpp>
#   include <ib_boost/mpl/aux_/arity_spec.hpp>
#   include <ib_boost/mpl/aux_/type_wrapper.hpp>
#   include <ib_boost/mpl/aux_/yes_no.hpp>
#   if defined(BOOST_NO_TEMPLATE_PARTIAL_SPECIALIZATION)
#       include <ib_boost/type_traits/is_reference.hpp>
#   endif 
#endif

#include <ib_boost/mpl/aux_/config/bind.hpp>
#include <ib_boost/mpl/aux_/config/static_constant.hpp>
...
#   include <ib_boost/mpl/aux_/preprocessor/params.hpp>
#   include <ib_boost/mpl/aux_/preprocessor/default_params.hpp>
#   include <ib_boost/mpl/aux_/preprocessor/def_params_tail.hpp>
#   include <ib_boost/mpl/aux_/preprocessor/partial_spec_params.hpp>
#   include <ib_boost/mpl/aux_/preprocessor/ext_params.hpp>
#   include <ib_boost/mpl/aux_/preprocessor/repeat.hpp>
#   include <ib_boost/mpl/aux_/preprocessor/enum.hpp>
#   include <ib_boost/mpl/aux_/preprocessor/add.hpp>
#   include <ib_boost/mpl/aux_/config/dmc_ambiguous_ctps.hpp>
#   include <ib_boost/mpl/aux_/config/ctps.hpp>
#   include <ib_boost/mpl/aux_/config/ttp.hpp>
#   include <ib_boost/mpl/aux_/config/dtp.hpp>
#   include <ib_boost/mpl/aux_/nttp_decl.hpp>

#   include <ib_boost/preprocessor/iterate.hpp>
#   include <ib_boost/preprocessor/comma_if.hpp>
...
#define BOOST_PP_ITERATION_PARAMS_1 \
    (3,(0, BOOST_MPL_LIMIT_METAFUNCTION_ARITY, <ib_boost/mpl/bind.hpp>))
...
#   define BOOST_PP_ITERATION_PARAMS_1 (3,(3, 3, <ib_boost/mpl/bind.hpp>))
#   include BOOST_PP_ITERATE()
...
#include <ib_boost/mpl/aux_/count_args.hpp>
}
...
#       define BOOST_PP_ITERATION_PARAMS_2 (3,(1, i_, <ib_boost/mpl/bind.hpp>))
#       include BOOST_PP_ITERATE()
