...
#include <ib_boost/type_traits/conversion_traits.hpp>
#include <ib_boost/type_traits/composite_traits.hpp> // for is_reference
...
namespace boost {
  namespace detail {
   ...
   template <class Gen> struct default_generator {
    ...
    // ib_boost/iterator_adaptors.hpp for an example usage.  Also,
